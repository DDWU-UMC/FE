...
font-weight: 600;
color: white;
border: 2.5px solid ${ke.secondary200};
border-radius: 30px;
margin: 2rem;
background-color:${ke.secondary200};
}
...
`,Kx=b.button`
  background-color: ${r=>r.$active==="true"?ke.primary:ke.btn};
  color: ${r=>r.$active==="true"?"white":ke.secondary50};
  border: 1px solid
    ${r=>r.$active==="true"?ke.primary:ke.primary900};
  padding: 5px 17px;
  border-radius: 5px;
  cursor: pointer;
  font-size: 15px;
